//
//  ItemDetailViewV3.swift
//  Organizer
//
//  Created by Olivier Miserez on 02/01/2021.
//  Copyright © 2021 Olivier Miserez. All rights reserved.
//

import Foundation
import UIKit

class ItemDetailViewV3: UIView {
    ...
    private func setup() {
        ...
        NSLayoutConstraint.activate([
            mainView.trailingAnchor.constraint(equalTo: backgroundView.trailingAnchor, constant: 0),
            mainView.leadingAnchor.constraint(equalTo: backgroundView.leadingAnchor, constant: 0),
...
//            mainView.bottomAnchor.constraint(equalTo: backgroundView.bottomAnchor, constant: 0)
        ])
